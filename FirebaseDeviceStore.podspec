#
#  Be sure to run `pod spec lint FirebaseDeviceStore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/csfrequency/firebase-device-store-ios-sdk"
  ...
  s.author             = { "Chris Bianca" => "chris@csfrequency.com" }
  # Or just: s.author    = "Chris Bianca"
  # s.authors            = { "Chris Bianca" => "me@chrisbianca.com" }
  # s.social_media_url   = "http://twitter.com/Chris Bianca"
